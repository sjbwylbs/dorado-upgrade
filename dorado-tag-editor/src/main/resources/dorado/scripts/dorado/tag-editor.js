...
(function () {
    ...
    dorado.widget.TagEditor = $extend(dorado.widget.AbstractTextBox, {$className:"dorado.widget.TagEditor", _inherentClassName:"i-tag-editor", _triggerChanged:true, ATTRIBUTES:{className:{defaultValue:"d-tag-editor"}, height:{independent:true}, text:{getter:function () {
