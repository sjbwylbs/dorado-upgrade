...
public class RuleTemplateParser extends ConfigurableDispatchableXmlParser {
	...
	public RuleTemplate getRuleTemplate(String name, ConfigRuleParseContext parserContext) throws Exception {
		RuleTemplate ruleTemplate = parserContext.getRuleTemplateMap().get(name);
	...
	protected Object doParse(Node node, ParseContext context) throws Exception {
		...
		if (parents != null) {
			List<RuleTemplate> parentList = new ArrayList<>();
		...
		if (propsEl != null) {
			ruleTemplate.addProperties((Collection<PropertyTemplate>) dispatchChildElements(propsEl, parserContext));
		}
