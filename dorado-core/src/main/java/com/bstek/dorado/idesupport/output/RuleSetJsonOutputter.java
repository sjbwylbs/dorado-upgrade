...
public class RuleSetJsonOutputter {
	...
	protected void outputPackageInfos(JsonBuilder jsonBuilder, RuleTemplateManager ruleTemplateManager,
	...
	protected void outputRuleTemplate(JsonBuilder jsonBuilder, RuleTemplate ruleTemplate, OutputContext context)
			throws Exception {
		jsonBuilder.object();
		...
		outputKeys(jsonBuilder, ruleTemplate,
	...
	protected void outputProperty(JsonBuilder jsonBuilder, PropertyTemplate property, OutputContext context)
			throws Exception {
		jsonBuilder.object();
	...
	protected void outputClientEvent(JsonBuilder jsonBuilder, ClientEvent clientEvent, OutputContext context)
			throws Exception {
		jsonBuilder.object();
		outputKeys(jsonBuilder, clientEvent, "name,parameters,clientTypes,deprecated,reserve");
		jsonBuilder.endObject();
	}

	protected void outputChildTemplate(JsonBuilder jsonBuilder, ChildTemplate childTemplate, OutputContext context)
			throws Exception {
		jsonBuilder.object();
		...
		outputKeys(jsonBuilder, childTemplate, "name,fixed,aggregated,clientTypes,deprecated,reserve");
