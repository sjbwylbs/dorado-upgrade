...
public abstract class DefinitionUtils {
	...
	public static Definition getDefinition(Object defOrRef) {
		if (defOrRef == null) {
			...
			throw new IllegalArgumentException(
					"Unrecognised Definition or DefinitionReference instance [" + defOrRef + "].");
		}
	}
	 ...
	 * ，将被转换成具体的数据或对象。</li>
	 * </ul>
	 * @param valueDefinition 值的声明
	 * @param context 创建最终对象的上下文
	 * @return 真正的数值
	 * @throws Exception
	 */
	public static Object getRealValue(Object valueDefinition, CreationContext context) throws Exception {
		if (valueDefinition != null) {
			Object value;
			if (valueDefinition instanceof DefinitionReference<?>) {
				Definition definition = ((DefinitionReference<?>) valueDefinition).getDefinition();
