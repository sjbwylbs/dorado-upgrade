...
public class TextParserHelper {
	...
	private Map<Class<?>, TextSectionInfo> textSectionInfoCache = new HashMap<>();
	...
	private void doGetTextSectionInfo(TextSectionInfo textSectionInfo, Class<?> type) {
	...
	private void collectXmlNodeInfo(TextSectionInfo textSectionInfo, Class<?> type) {
