...
public class TextParseException extends Exception {
	 ...
	 * @param context 解析上下文
	 */
	public TextParseException(String message, char[] charArray, TextParseContext context) {
		super(populateErrorMessage(message, charArray, context));
	}

	private static String populateErrorMessage(String message, char[] charArray, TextParseContext context) {
