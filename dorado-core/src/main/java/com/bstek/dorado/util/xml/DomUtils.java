...
public abstract class DomUtils {
	 ...
	 */
	public static List<Element> getChildrenByTagName(Element element, String childElementName) {
		return org.springframework.util.xml.DomUtils.getChildElementsByTagName(element, childElementName);
	}
