...
public class WeakHashSet<E> implements Set<E> {
	...
	private Map<E, Object> map = new WeakHashMap<>();
	...
	/**
	 * Returns <tt>true</tt> if this set contains all of the elements of the specified
	 * collection.
	 * @param c collection to be checked for containment in this set.
	 * @return <tt>true</tt> if this set contains all of the elements of the specified
	 * collection.
	 */
	@Override
