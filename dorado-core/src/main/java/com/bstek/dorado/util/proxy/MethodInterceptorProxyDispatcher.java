...
public class MethodInterceptorProxyDispatcher extends MethodInterceptorDispatcher {
	...
	private static class FinalCglibMethodInterceptor implements MethodInterceptor {
		...
		public Object invoke(MethodInvocation methodInvocation) throws Throwable {
			return methodProxy.invoke(methodInvocation.getThis(), methodInvocation.getArguments());
		}
	...
	/**
	 * @param target 被代理的对象。
	 * @param subMethodInterceptors 等待分派的子方法拦截器的数组。
	 */
	public MethodInterceptorProxyDispatcher(Object target, MethodInterceptor[] subMethodInterceptors) {
	...
	protected MethodInvocation createMethodInvocation(Object object, Method method, Object[] args,
		...
		return new ChainedMethodInvocation(object, target, method, args, methodInterceptorChain);
	}
