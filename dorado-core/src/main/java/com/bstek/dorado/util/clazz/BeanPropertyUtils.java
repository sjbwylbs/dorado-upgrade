...
public abstract class BeanPropertyUtils {
	...
	public static boolean isValidProperty(Class<?> beanClass, String property) {
		...
		return (!"class".equals(property) && !"callbacks".equals(property) && !"handler".equals(property)
				&& !"hibernateLazyInitializer".equals(property));
	}

	public static Object getFieldValue(Object bean, String property) throws Exception {
		Field field = bean.getClass().getDeclaredField(property);
		field.setAccessible(true);
		return field.get(bean);
	}

	public static void setFieldValue(Object bean, String property, Object value) throws Exception {
		Field field = bean.getClass().getDeclaredField(property);
		field.setAccessible(true);
