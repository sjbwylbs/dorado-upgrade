 ...
 *
 */
@XmlNode(nodeName = "DataType", parser = "spring:dorado.prototype.dataTypeParser",
		definitionType = "com.bstek.dorado.data.config.definition.DataTypeDefinition", inheritable = true,
		properties = { @XmlProperty(propertyName = "overwrite", propertyType = "boolean", attributeOnly = true,
				ignored = true), @XmlProperty(propertyName = "cachable", propertyType = "java.lang.Boolean") })
