...
public abstract class InterceptableDefinition extends ListenableObjectDefinition {
	...
	protected void initCreationInfo(CreationInfo creationInfo, ObjectDefinition definition, boolean processConstrInfos)
		...
		creationInfo.setUserData("interceptor", interceptableDefinition.getInterceptor());
	}
	...
	protected abstract MethodInterceptor getInterceptorInvoker(String interceptor);
