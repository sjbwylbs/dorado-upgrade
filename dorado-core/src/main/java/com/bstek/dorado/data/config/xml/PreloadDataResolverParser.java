...
public class PreloadDataResolverParser extends ConfigurableDispatchableXmlParser {
	...
	protected Object doParse(Node node, ParseContext context) throws Exception {
		...
		if (configuredDataResolvers.containsKey(name)) {
			...
			if (!overwrite) {
				throw new XmlParseException(DataXmlConstants.DATA_RESOLVER + " [" + name + "] is not unique!", element,
						context);
			}
		}
