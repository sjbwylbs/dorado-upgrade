...
public class DataElementParserSupport extends GenericParser {
	 ...
	 * @throws Exception
	 */
	protected DataType getCurrentDataType(DataParseContext context) throws Exception {
		DataType dataType = null;
		DefinitionReference<DataTypeDefinition> dataTypeRef = context.getCurrentDataType();
		if (dataTypeRef != null) {
			dataType = (DataType) dataTypeRef.getDefinition().create(new DataCreationContext());
		}
		return dataType;
	}
