...
public class DataProviderInterceptorInvoker implements MethodInterceptor {
	...
	private Criterion evaluateCriterion(Criterion criterion) throws Exception {
		...
		if (criterion instanceof Junction) {
			...
			Junction newJunction = junction.getClass().getDeclaredConstructor().newInstance();
	...
	private Object invokeInterceptorByParamName(DataProvider dataProvider, Method[] methods,
		...
		return MethodAutoMatchingUtils.invokeMethod(methods, interceptor, requiredParameterNames, requiredParameters,
	...
	private Object invokeInterceptorByParamType(DataProvider dataProvider, Method[] methods,
		...
		return MethodAutoMatchingUtils.invokeMethod(methods, interceptor, requiredArgTypes, requiredArgs, exactArgTypes,
				exactArgs, optionalArgTypes, optionalArgs, null);
	}
