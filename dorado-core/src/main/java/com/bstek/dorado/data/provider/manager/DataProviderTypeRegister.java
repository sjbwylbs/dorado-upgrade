 ...
 */
public class DataProviderTypeRegister implements InitializingBean, RemovableBean {

	private static final Log logger = LogFactory.getLog(DataProviderTypeRegister.class);
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			DataProviderTypeRegisterInfo registerInfo = new DataProviderTypeRegisterInfo(type, cl);
