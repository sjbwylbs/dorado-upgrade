 ...
 * 聚合类型。
 * <p>
 * 聚合类型主要包括java.util.List、java.util.Set、java.util.Iterator、java.util. Enumeration的实现类
 * 以及java.lang.Array的派生类型。
 * </p>
 * <p>
...
public class AggregationDataType extends AbstractDataType implements MutableDataType {
	...
	public Object fromObject(Object value) {
		...
		if (Collection.class.isAssignableFrom(targetType)) {
			...
			if (creationType != null && Collection.class.isAssignableFrom(creationType)
					&& !Modifier.isAbstract(creationType.getModifiers())) {
				try {
					collection = (Collection) creationType.getDeclaredConstructor().newInstance();
				}
				catch (Exception e) {
					throw new DataConvertException(value.getClass(), getMatchType(), e);
				}
