...
public class DataTypeName {
	...
	private void throwInvalidFormatException(String dataTypeName) throws IllegalArgumentException {
		throw new IllegalArgumentException("Invalid [" + DataXmlConstants.DATA_TYPE + "] name [" + dataTypeName + "]!");
	}
