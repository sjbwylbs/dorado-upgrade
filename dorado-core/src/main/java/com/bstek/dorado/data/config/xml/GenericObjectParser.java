...
public class GenericObjectParser extends ObjectParser {
	...
	private static final Log logger = LogFactory.getLog(GenericObjectParser.class);
	...
	protected void initDefinition(ObjectDefinition definition, Element element, ParseContext context) throws Exception {
		...
		if (definition instanceof ListenableObjectDefinition) {
			String listener = (String) definition.removeProperty(DataXmlConstants.ATTRIBUTE_LISTENER);
