 ...
 *
 */
public class PreloadDataProviderParser extends ConfigurableDispatchableXmlParser {
	...
	protected Object doParse(Node node, ParseContext context) throws Exception {
		...
		if (configuredDataProviders.containsKey(name)) {
			...
			if (!overwrite) {
				throw new XmlParseException(DataXmlConstants.DATA_PROVIDER + " [" + name + "] is not unique!", element,
						context);
			}
		}
