...
@ClientEvents({ @com.bstek.dorado.annotation.ClientEvent(name = "beforeLoadData"),
...
public class Reference extends LazyPropertyDef {
	 ...
	 */
	@XmlProperty
	@ClientProperty(outputter = "spring:dorado.doradoMapPropertyOutputter", evaluateExpression = false)
	 ...
	 * <p>
	 * 默认情况下，如果没有特别指定此参数， 系统将会将当前的实体数据(即此属性所属的EntityDataType型的数据)作为DataProvider的参数。
	 * </p>
	 */
