	...
	public static VariantConvertor getVariantConvertor() {
		if (variantConvertor == null) {
			try {
				...
				variantConvertor = (VariantConvertor) SingletonBeanFactory.getInstance(className);
				...
				if (variantConvertor instanceof DataConfigManagerListener) {
					...
					dataConfigManager.addConfigManagerListener((DataConfigManagerListener) variantConvertor);
				}
			}
			catch (Exception e) {
