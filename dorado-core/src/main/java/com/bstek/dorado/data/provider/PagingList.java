...
public class PagingList<E> extends ListProxySupport<E> {
	...
	private Map<Integer, Page<E>> pageMap = new HashMap<>();
	...
	public PagingList(DataProvider dataProvider, DataType dataType, Object parameter, int pageSize) throws Exception {
