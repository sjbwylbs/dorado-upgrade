 ...
 *
 */
@XmlNode(definitionType = "com.bstek.dorado.data.config.definition.PropertyDefDefinition",
...
public abstract class PropertyDef implements Ignorable, TagSupport, MetaDataSupport, ClientEventSupported {
	...
	@XmlSubNode(nodeName = "Validator", parser = "spring:dorado.validatorParserDispatcher")
	@ClientProperty
