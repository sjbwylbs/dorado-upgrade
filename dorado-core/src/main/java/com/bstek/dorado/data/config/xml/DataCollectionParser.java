...
public class DataCollectionParser extends DataElementParserSupport {
	...
	/**
	 * 设置具体的集合类实现类型。
	 * @param collectionType 集合类实现类型，例如:java.util.ArrayList
	 * @throws ClassNotFoundException
	 */
	@SuppressWarnings("unchecked")
	public void setDefaultCollectionType(String defaultCollectionType) throws ClassNotFoundException {
	...
	protected Object internalParse(Node node, DataParseContext context) throws Exception {
		...
		List<Object> entities = (List<Object>) super.dispatchChildElements(element, context);
