...
public class DefaultMapEntityInterceptor extends MapEntityEnhancer implements MethodInterceptor {
	...
	public Object interceptor(MethodInvocation methodInvocation) throws Throwable {
		...
		else if (PUT.equals(mothedName) && method.getParameterTypes().length == 2) { // write
			String property = (String) methodInvocation.getArguments()[0];
	...
	protected Object interceptReadMethod(MethodInvocation methodInvocation, String property) throws Throwable {
		return interceptReadMethod(methodInvocation.getThis(), property, methodInvocation.proceed(), false);
	}

	protected boolean interceptWriteMethod(MethodInvocation methodInvocation, String property) throws Throwable {
		return interceptWriteMethod(methodInvocation.getThis(), property, methodInvocation.getArguments()[1], false);
	}
