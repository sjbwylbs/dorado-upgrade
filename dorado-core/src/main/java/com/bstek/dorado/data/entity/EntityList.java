...
public class EntityList<E> extends EntityCollection<E> implements List<E> {
	...
	/**
	 * @param target 被代理的{@link java.util.List}对象
	 * @param dataType 相应的数据类型
	 * @throws Exception
	 */
	public EntityList(List<E> target, AggregationDataType dataType) throws Exception {
	...
	protected void replaceAllElementWithProxyIfNecessary(Collection<? extends E> collection) {
