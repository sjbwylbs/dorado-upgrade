 ...
 *
 */
@XmlNode(nodeName = "DataProvider", parser = "spring:dorado.prototype.dataProviderParser",
		definitionType = "com.bstek.dorado.data.config.definition.DataProviderDefinition", scopable = true,
		inheritable = true,
		properties = {
...
public interface DataProvider extends DataModelObject {
	 ...
	 * @throws Exception
	 */
	Object getResult(Object parameter, DataType resultDataType) throws Exception;
	 ...
	 * @see com.bstek.dorado.data.provider.Page
	 */
	void getPagingResult(Object parameter, Page<?> page, DataType resultDataType) throws Exception;
