...
public class ComplexDataTypeNameUnsupportedException extends XmlParseException {
	 ...
	 * @param context 解析上下文
	 */
	public ComplexDataTypeNameUnsupportedException(String message, ParseContext context) {
	 ...
	 * @param context 解析上下文
	 */
	public ComplexDataTypeNameUnsupportedException(String message, Node node, ParseContext context) {
