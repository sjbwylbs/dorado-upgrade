 ...
 */
public class DataObjectAnnotationEngineStartupListener extends EngineStartupListener
	...
	private static final Log logger = LogFactory.getLog(DataObjectAnnotationEngineStartupListener.class);
	...
	private Set<PendingDataObject> pendingDataObjects = new HashSet<>();
	...
	protected String autoRegisterDataObject(PendingDataObject pendingDataObject) throws Exception {
	...
	public void onStartup() throws Exception {
		...
		if (dataObjectsText.length() > 0) {
			logger.info("Registered DataObjects(via Annotation): [" + dataObjectsText + "]");
		}
	}
...
class PendingDataObject {
	...
	public PendingDataObject(DataObjectType type, Annotation annotation, String beanName, String methodName) {
		this.type = type;
	...
	public boolean equals(Object obj) {
		...
		return (uniqueName != null) ? uniqueName.equals(((PendingDataObject) obj).uniqueName) : super.equals(obj);
	}
