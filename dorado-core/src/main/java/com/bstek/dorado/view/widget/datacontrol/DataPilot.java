...
@ClientObject(prototype = "dorado.widget.DataPilot", shortTypeName = "DataPilot")
@ClientEvents({ @ClientEvent(name = "onSubControlRefresh"), @ClientEvent(name = "onSubControlAction") })
