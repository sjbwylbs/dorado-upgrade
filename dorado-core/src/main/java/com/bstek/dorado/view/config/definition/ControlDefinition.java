...
public class ControlDefinition extends ComponentDefinition {
		...
		if (layoutConstraint == null && getParents() != null) {
			for (Definition parent : getParents()) {
				if (parent instanceof ControlDefinition) {
					layoutConstraint = ((ControlDefinition) parent).getFinalLayoutConstraint();
	...
	protected void doInitObject(Object object, CreationInfo creationInfo, CreationContext context) throws Exception {
		...
		Object layoutConstraint = DefinitionUtils.getRealValue(layoutConstraintDefinition, context);
	...
	protected Object clone() throws CloneNotSupportedException {
		...
		definition.layoutConstraint = (layoutConstraint != null) ? CloneUtils.clone(layoutConstraint) : null;
		return definition;
	}
