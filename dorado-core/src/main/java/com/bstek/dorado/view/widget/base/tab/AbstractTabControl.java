...
@ClientEvents({ @ClientEvent(name = "beforeTabChange"), @ClientEvent(name = "onTabChange"),
		@ClientEvent(name = "onTabRemove"), @ClientEvent(name = "onTabContextMenu") })
...
public abstract class AbstractTabControl extends Control {
	...
	private List<Tab> tabs = new InnerElementList<>(this);
	...
	public void setCurrentTab(String currentTabName) {
		...
		throw new IllegalArgumentException("No such Tab [" + currentTabName + "] in TabControl.");
	}
