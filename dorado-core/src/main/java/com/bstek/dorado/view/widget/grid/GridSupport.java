...
@ClientEvents({ @ClientEvent(name = "onGetCellEditor"), @ClientEvent(name = "onRenderRow"),
		@ClientEvent(name = "onRenderCell"), @ClientEvent(name = "onRenderHeaderCell"),
		@ClientEvent(name = "onRenderFooterCell"), @ClientEvent(name = "onHeaderClick"),
		@ClientEvent(name = "beforeCellValueEdit"), @ClientEvent(name = "onCellValueEdit") })
