 ...
 *
 */
@XmlNode(definitionType = "com.bstek.dorado.view.config.definition.ControlDefinition",
...
@ClientEvents({ @ClientEvent(name = "onCreateDom"), @ClientEvent(name = "beforeRefreshDom"),
		@ClientEvent(name = "onRefreshDom"), @ClientEvent(name = "onClick", clientTypes = ClientType.DESKTOP),
		@ClientEvent(name = "onDoubleClick", clientTypes = ClientType.DESKTOP), @ClientEvent(name = "onMouseDown"),
		@ClientEvent(name = "onMouseUp"), @ClientEvent(name = "onFocus"), @ClientEvent(name = "onBlur"),
		@ClientEvent(name = "onKeyDown"), @ClientEvent(name = "onKeyPress"), @ClientEvent(name = "onContextMenu"),
		@ClientEvent(name = "onResize"), @ClientEvent(name = "onGetDraggingIndicator"),
		@ClientEvent(name = "onDragStart"), @ClientEvent(name = "onDragStop"), @ClientEvent(name = "onDragMove"),
		@ClientEvent(name = "onDraggingSourceOver"), @ClientEvent(name = "onDraggingSourceOut"),
		@ClientEvent(name = "onDraggingSourceMove"), @ClientEvent(name = "beforeDraggingSourceDrop"),
		@ClientEvent(name = "onDraggingSourceDrop"), @ClientEvent(name = "onTap", clientTypes = ClientType.TOUCH),
...
public abstract class Control extends Component implements HtmlElement, RenderableElement {
