...
public class ViewParser extends ContainerParser {
	...
	protected ObjectDefinition createDefinition(Element element, ParseContext context) throws Exception {
		...
		ViewDefinition viewDefinition = new ViewDefinition(viewContext.getCurrentComponentTypeRegisterInfo());
		ViewConfigDefinition viewConfigDefinition = viewContext.getViewConfigDefinition();
