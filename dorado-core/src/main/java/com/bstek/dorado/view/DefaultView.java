...
@ClientObject(usePrototype = true, prototype = "dorado.widget.View", shortTypeName = "View",
		outputter = "spring:dorado.viewOutputter", properties = @ClientProperty(propertyName = "context",
