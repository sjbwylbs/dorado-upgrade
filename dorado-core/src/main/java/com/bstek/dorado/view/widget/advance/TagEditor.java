...
@ClientEvents({ @ClientEvent(name = "beforeUnknownTagAccept"), @ClientEvent(name = "onUnknownTagAccept"),
		@ClientEvent(name = "beforeTagRemove"), @ClientEvent(name = "onTagRemove"), @ClientEvent(name = "beforeTagAdd"),
