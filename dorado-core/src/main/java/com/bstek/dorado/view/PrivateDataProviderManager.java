...
public class PrivateDataProviderManager extends DefaultDataProviderManager {
	...
	public PrivateDataProviderManager(DataProviderManager parent,
	...
	public DataProvider getDataProvider(String name) throws Exception {
		ViewConfigDefinition viewConfigDefinition = privateDataProviderDefinitionManager.getViewConfigDefinition();
