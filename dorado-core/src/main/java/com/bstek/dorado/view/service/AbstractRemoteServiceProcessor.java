...
public abstract class AbstractRemoteServiceProcessor extends DataServiceProcessorSupport {
	...
	public static final String SERVICE_NAME_ATTRIBUTE = AbstractRemoteServiceProcessor.class.getName() + ".serviceName";

	private static final Log logger = LogFactory.getLog(RemoteServiceProcessor.class);

	private static final ResourceManager resourceManager = ResourceManagerUtils.get(RemoteServiceProcessor.class);
	...
	protected Object invokeRemoteService(Writer writer, DoradoContext context, String serviceName, Object parameter,
			String[] requiredParameterNames, Type[] requiredParameterTypes, Object[] requiredParameters)
			throws Exception {
		...
		try {
			try {
				returnValue = invokeByParameterName(serviceBean, methods, parameter, requiredParameterNames,
			...
			if (!methodInvoked) {
				try {
					returnValue = invokeByParameterType(serviceBean, methods, parameter, requiredParameterTypes,
							requiredParameters, false);
					methodInvoked = true;
				}
				catch (MoreThanOneMethodsMatchsException e) {
	...
	protected Object invokeByParameterName(Object serviceBean, Method[] methods, Object parameter,
			String[] requiredParameterNames, Object[] requiredParameters, boolean disassembleParameter)
		...
		return MethodAutoMatchingUtils.invokeMethod(methods, serviceBean, requiredParameterNames, requiredParameters,
				optionalParameterNames, optionalParameters, extraParameterNames, extraParameters);
	}

	protected Object invokeByParameterType(Object serviceBean, Method[] methods, Object parameter,
			Type[] requiredParameterTypes, Object[] requiredParameters, boolean disassembleParameter)
			throws MethodAutoMatchingException, Exception {
		Map<String, Object> sysParameter = null;
		if (parameter instanceof ParameterWrapper) {
			ParameterWrapper parameterWrapper = (ParameterWrapper) parameter;
		...
		return MethodAutoMatchingUtils.invokeMethod(methods, serviceBean, requiredParameterTypes, requiredParameters,
				exactArgTypes, exactArgs, optionalParameterTypes, optionalParameters, null);
	}
