...
@ClientEvents({ @ClientEvent(name = "onCurrentChange"), @ClientEvent(name = "beforeSelectionChange"),
		@ClientEvent(name = "onSelectionChange"), @ClientEvent(name = "onCompareItems"),
