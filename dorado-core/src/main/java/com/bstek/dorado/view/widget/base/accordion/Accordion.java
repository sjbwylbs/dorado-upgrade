...
@Widget(name = "Accordion", category = "General", dependsPackage = "base-widget-desktop")
@ClientObject(prototype = "dorado.widget.Accordion", shortTypeName = "Accordion")
@ClientEvents({ @ClientEvent(name = "beforeCurrentSectionChange"), @ClientEvent(name = "onCurrentSectionChange") })
@ResourceInjection(subObjectMethod = "getSection")
public class Accordion extends Control {

	private List<Section> sections = new InnerElementList<>(this);
	...
	public void setCurrentSection(Section currentSection) {
		...
		if (i >= 0) {
			...
			throw new IllegalArgumentException("The current Section must belongs to this SectionControl.");
		}
	}
	...
	public void setCurrentSection(String currentSectionName) {
		...
		throw new IllegalArgumentException("No such Section [" + currentSectionName + "] in SectionControl.");
	}
