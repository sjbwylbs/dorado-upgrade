...
public class PrivateDataProviderDefinitionManager extends DataProviderDefinitionManager {

	private String dataObjectIdPrefix;

	private ViewConfigDefinition viewConfigDefinition;

	public PrivateDataProviderDefinitionManager(DefinitionManager<DataProviderDefinition> parent) {
		super(parent);
	}
	...
	@Override
	public void registerDefinition(String name, DataProviderDefinition definition) {
		...
		DataObjectDefinitionUtils.setDataProviderId(definition, dataObjectIdPrefix + id);
	...
	public PrivateDataProviderDefinitionManager duplicate() {
		PrivateDataProviderDefinitionManager duplication = new PrivateDataProviderDefinitionManager(getParent());
