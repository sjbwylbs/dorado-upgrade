...
@XmlNode(definitionType = "com.bstek.dorado.view.config.definition.ViewDefinition", parser = "spring:dorado.viewParser",
		implTypes = "com.bstek.dorado.view.*")
@ClientEvents({ @ClientEvent(name = "onLoadData"), @ClientEvent(name = "onComponentRegistered"),
		@ClientEvent(name = "onComponentUnregistered") })
public abstract class View extends Container {

	private ViewConfig viewConfig;

	private Map<String, ViewElement> viewElementMap = new HashMap<>();
	...
	public void registerViewElement(ViewElement viewElement) {
		...
		if (StringUtils.isNotEmpty(id)) {
			if (viewElementMap.containsKey(id)) {
				throw new IllegalArgumentException("Duplicated viewElement [" + id + "].");
			}
