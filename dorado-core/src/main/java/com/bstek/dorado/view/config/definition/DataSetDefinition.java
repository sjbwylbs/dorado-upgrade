...
public class DataSetDefinition extends ComponentDefinition {
	...
	protected void doInitObject(Object object, CreationInfo creationInfo, CreationContext context) throws Exception {
		...
		dataSet.setDataType((DataType) DefinitionUtils.getRealValue(dataType, context));

		dataSet.setDataProvider((DataProvider) DefinitionUtils.getRealValue(dataProvider, context));
