...
public abstract class VelocityHelper {
	...
	public Context getContext(View view, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Context context = createContext();
		initContext(context, view, request, response);
		return context;
	}

	protected void initContext(Context context, View view, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
