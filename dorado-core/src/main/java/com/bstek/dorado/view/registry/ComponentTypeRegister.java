 ...
 *
 */
public abstract class ComponentTypeRegister
		implements InitializingBean, BeanFactoryAware, BeanNameAware, RemovableBean {

	private static final Log logger = LogFactory.getLog(ComponentTypeRegister.class);
