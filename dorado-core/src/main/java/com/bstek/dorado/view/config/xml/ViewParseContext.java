...
public class ViewParseContext extends DataParseContext {
	...
	public static class LayoutInfo {
		...
		public LayoutInfo(Element containerElement, LayoutTypeRegisterInfo layoutTypeRegisterInfo) {
	...
	private Stack<LayoutInfo> currentLayoutStack = new Stack<>();
	...
	public void setCurrentComponentTypeRegisterInfo(ComponentTypeRegisterInfo currentComponentTypeRegisterInfo) {
	...
	public String getPrivateNameSection(Node node) {
		if (node instanceof Element) {
			...
			if (parentNode != null) {
				if (ViewXmlConstants.VIEW_CONFIG.equals(parentNode.getNodeName())) {
					return null;
				}
			}
		}
