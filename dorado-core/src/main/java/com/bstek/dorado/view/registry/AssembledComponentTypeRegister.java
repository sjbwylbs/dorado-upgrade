...
public class AssembledComponentTypeRegister extends ComponentTypeRegister {
	...
	protected ComponentTypeRegisterInfo createRegisterInfo(String name) {
		AssembledComponentTypeRegisterInfo registerInfo = new AssembledComponentTypeRegisterInfo(name);
	...
	protected ComponentTypeRegisterInfo getRegisterInfo() throws Exception {
		...
		Map<String, VirtualPropertyDescriptor> propertieDescriptors = new HashMap<>();
		...
		Map<String, VirtualEventDescriptor> eventDescriptors = new HashMap<>();
