...
@Widget(name = "FormSubmitAction", category = "Action", dependsPackage = "base-widget", autoGenerateId = true)
@ClientObject(prototype = "dorado.widget.FormSubmitAction", shortTypeName = "FormSubmitAction")
