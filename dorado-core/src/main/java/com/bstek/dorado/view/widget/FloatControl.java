...
@ClientEvents({ @ClientEvent(name = "beforeShow"), @ClientEvent(name = "onShow"), @ClientEvent(name = "beforeHide"),
		@ClientEvent(name = "onHide"), @ClientEvent(name = "beforeClose"), @ClientEvent(name = "onClose") })
