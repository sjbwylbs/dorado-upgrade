...
public class LayoutTypeRegister implements InitializingBean, RemovableBean {
	...
	private static final Log logger = LogFactory.getLog(LayoutTypeRegister.class);
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			if (StringUtils.isNotEmpty(constraintClassType)) {
				constraintCl = (Class<? extends LayoutConstraintSupport>) Class.forName(constraintClassType);
			}

			LayoutTypeRegisterInfo registerInfo = new LayoutTypeRegisterInfo(type, cl, constraintCl);
