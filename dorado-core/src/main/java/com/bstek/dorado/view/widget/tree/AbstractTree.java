...
@ClientEvents({ @ClientEvent(name = "beforeExpand"), @ClientEvent(name = "onExpand"),
		@ClientEvent(name = "beforeCollapse"), @ClientEvent(name = "onCollapse"), @ClientEvent(name = "onNodeAttached"),
		@ClientEvent(name = "onNodeDetached"), @ClientEvent(name = "beforeCurrentChange"),
		@ClientEvent(name = "onRenderNode"), @ClientEvent(name = "beforeNodeCheckedChange"),
