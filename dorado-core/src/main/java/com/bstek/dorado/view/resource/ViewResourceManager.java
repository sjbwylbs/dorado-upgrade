...
public class ViewResourceManager extends AbstractResourceManagerSupport {
	...
	public void setViewResourceBundleManager(ViewResourceBundleManager viewResourceBundleManager) {
		this.viewResourceBundleManager = viewResourceBundleManager;
	}

	protected ResourceBundle getBundle(ViewConfigDefinition viewConfigDefinition, Locale locale) throws Exception {
		return viewResourceBundleManager.getBundle(viewConfigDefinition, locale);
	}

	public ResourceBundle getBundle(ViewConfigDefinition viewConfigDefinition) throws Exception {
		Locale locale = getLocale();
		return getBundle(viewConfigDefinition, locale);
	}

	public String getString(ViewConfigDefinition viewConfigDefinition, String path, Object... args) throws Exception {
		Locale locale = getLocale();
		String result = null;
