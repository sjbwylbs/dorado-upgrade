...
public class PrivateDataResolverDefinitionManager extends DataResolverDefinitionManager {

	private String dataObjectIdPrefix;

	private ViewConfigDefinition viewConfigDefinition;

	public PrivateDataResolverDefinitionManager(DefinitionManager<DataResolverDefinition> parent) {
		super(parent);
	}
	...
	@Override
	public void registerDefinition(String name, DataResolverDefinition definition) {
		...
		DataObjectDefinitionUtils.setDataResolverId(definition, dataObjectIdPrefix + id);
	...
	public PrivateDataResolverDefinitionManager duplicate() {
		PrivateDataResolverDefinitionManager duplication = new PrivateDataResolverDefinitionManager(getParent());
