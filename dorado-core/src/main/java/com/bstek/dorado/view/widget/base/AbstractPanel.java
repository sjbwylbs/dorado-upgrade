...
public abstract class AbstractPanel extends Container {
	...
	@XmlSubNode(nodeName = "*", parser = "spring:dorado.childComponentParser",
			wrapper = @XmlNodeWrapper(nodeName = "Buttons", icon = "/com/bstek/dorado/view/widget/base/Buttons.png"))
	@ClientProperty
	...
	@Override
	@XmlSubNode(nodeName = "*", parser = "spring:dorado.childComponentParser",
			wrapper = @XmlNodeWrapper(nodeName = "Children", icon = "/com/bstek/dorado/view/widget/base/Children.png"))
	@ClientProperty
