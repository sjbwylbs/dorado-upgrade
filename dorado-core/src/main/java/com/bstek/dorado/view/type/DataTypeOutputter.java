...
public class DataTypeOutputter implements Outputter {
	...
	public void setAggregationDataTypeOutputter(Outputter aggregationDataTypeOutputter) {
	...
	private void throwUnsupportedDataTypeException(Object object) {
		throw new IllegalArgumentException("Unsupported DataType [" + object.getClass() + "].");
	}
