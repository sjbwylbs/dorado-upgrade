...
public class LayoutTypeRegisterInfo {
	...
	public LayoutTypeRegisterInfo(String type, Class<? extends Layout> classType,
	...
	public void setConstraintClassType(Class<? extends LayoutConstraintSupport> constraintClassType) {
		this.constraintClassType = constraintClassType;
	}
