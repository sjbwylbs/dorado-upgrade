	...
	protected void doInitObject(Object object, CreationInfo creationInfo, CreationContext context) throws Exception {
		...
		try {
			...
			PrivateDataTypeManager dataTypeManager = new PrivateDataTypeManager(
					(DataTypeManager) doradoContext.getServiceBean("dataTypeManager"), innerDataTypeDefinitionManager,
					innerDataProviderDefinitionManager, innerDataResolverDefinitionManager);
