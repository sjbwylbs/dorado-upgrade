...
@XmlNode(definitionType = "com.bstek.dorado.view.config.definition.ContainerDefinition",
		parser = "spring:dorado.containerParser", clientTypes = { ClientType.DESKTOP, ClientType.TOUCH })
@ClientObject(prototype = "dorado.widget.Container", shortTypeName = "Container",
...
public class Container extends Control {
	 ...
	 * @param component 要添加的子控件
	 * @param index 新添加的子控件在兄弟子控件中的位置序号，该序号是从0开始计数的。
	 */
	...
	public void removeChild(Component component) {
		if (internalGetChildren().remove(component)) {
			...
			throw new IllegalStateException("The child to be remove does not belong to this Container.");
		}
	}
	...
	public List<Component> getChildren() {
		if (childrenProxy == null) {
			childrenProxy = new ChildrenList<>(internalGetChildren());
		}
