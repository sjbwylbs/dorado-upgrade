...
public class PrivateDataResolverManager extends DefaultDataResolverManager {
	...
	public PrivateDataResolverManager(DataResolverManager parent,
	...
	public DataResolver getDataResolver(String name) throws Exception {
		ViewConfigDefinition viewConfigDefinition = privateDataResolverDefinitionManager.getViewConfigDefinition();
