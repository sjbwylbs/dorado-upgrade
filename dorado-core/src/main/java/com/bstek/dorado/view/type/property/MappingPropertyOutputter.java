...
public class MappingPropertyOutputter extends DataOutputter {
	...
	@SuppressWarnings("rawtypes")
	protected void outputCollection(Mapping mapping, Collection mapValues, OutputContext context) throws Exception {
		String keyProperty = StringUtils.defaultIfEmpty(mapping.getKeyProperty(), "key");
		String valueProperty = StringUtils.defaultIfEmpty(mapping.getValueProperty(), "value");
	...
	protected void outputMap(Map mapValues, OutputContext context) throws Exception {
		JsonBuilder json = context.getJsonBuilder();
		json.array();
