...
public class DefaultGlobalResourceBundleManager extends GlobalResourceBundleManagerSupport {

	private static final String RESOURCE_FILE_SUFFIX = ".properties";

	private Set<String> searchPaths = new LinkedHashSet<>();
	...
	@Override
	protected ResourceBundle doGetBundle(String bundleName, Locale locale) throws Exception {
	...
	protected Resource findResource(String bundleName, Locale locale) throws Exception {
		for (String searchPath : searchPaths) {
			Resource resource = findResourceInPath(searchPath, bundleName, locale);
