...
public class ScopeManager {
	...
	private static final String CONTEXT_KEY = ScopeManager.class.getName() + ".CONTEXT";

	private static Map<String, Object> singletonContext = new Hashtable<>();
	...
	public Object getBean(Scope scope, String key) {
		if (Scope.singleton.equals(scope)) {
			...
			Map<String, Object> map = (Map<String, Object>) context.getAttribute(Context.THREAD, CONTEXT_KEY);
