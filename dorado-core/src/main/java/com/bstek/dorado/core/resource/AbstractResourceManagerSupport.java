...
public abstract class AbstractResourceManagerSupport {
	...
	private static final Log logger = LogFactory.getLog(AbstractResourceManagerSupport.class);
	...
	public void setGlobalResourceBundleManager(GlobalResourceBundleManager globalResourceBundleManager) {
	...
	protected String getString(Locale locale, String path, Object... args) {
		try {
			...
			ResourceBundle bundle = globalResourceBundleManager.getBundle(bundleName, locale);
