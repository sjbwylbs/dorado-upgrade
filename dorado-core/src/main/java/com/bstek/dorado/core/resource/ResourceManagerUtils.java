...
public class ResourceManagerUtils {
	...
	public static ResourceManager get(String bundleName) {
		...
		try {
			resourceManager = (ResourceManager) Context.getCurrent().getServiceBean("resourceManager");
		}
...
class LazyInitResourceManager implements ResourceManager {
	...
	private static final Log logger = LogFactory.getLog(LazyInitResourceManager.class);
