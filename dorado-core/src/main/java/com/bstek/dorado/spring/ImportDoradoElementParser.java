...
public class ImportDoradoElementParser implements BeanDefinitionParser {
	...
	private static final Log logger = LogFactory.getLog(ImportDoradoElementParser.class);
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		try {
			...
			Class<DoradoAppContextImporter> cl = (Class<DoradoAppContextImporter>) ClassUtils.forName(DEFAULT_IMPORTER,
					getClass().getClassLoader());
			DoradoAppContextImporter importer = cl.getDeclaredConstructor().newInstance();
