...
public class AddonController {
	...
	public Collection<Addon> getAddonList() throws Exception {
		...
		Iterator<PackageInfo> iterator = PackageManager.getPackageInfoMap().values().iterator();
		Addon addon;
		...
		while (iterator.hasNext()) {
			...
			com.bstek.dorado.core.pkgs.Dependence[] depends = packageInfo.getDepends();
			Dependence depend;
			List<Dependence> dependList = new ArrayList<>();
			...
			addon.setServletContextLocations(packageInfo.getServletContextLocations());
