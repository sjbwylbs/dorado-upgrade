...
public class Addon {
	...
	public void setPropertiesLocations(String propertiesLocations) {
		this.propertiesLocations = StringUtils.isNotEmpty(propertiesLocations)
				? propertiesLocations.replaceAll(",", ",\n") : propertiesLocations;
	}
	...
	public void setContextLocations(String contextLocations) {
		this.contextLocations = StringUtils.isNotEmpty(contextLocations) ? contextLocations.replaceAll(",", ",\n")
				: contextLocations;
	}
	...
	public void setServletContextLocations(String servletContextLocations) {
		this.servletContextLocations = StringUtils.isNotEmpty(servletContextLocations)
				? servletContextLocations.replaceAll(",", ",\n") : servletContextLocations;
	}
