...
public final class DoradoContextUtils {
	...
	private static final String STACK_ATTRIBUTE = DoradoContextUtils.class.getName() + ".stack";

	private static final String MAP_ATTRIBUTE = DoradoContextUtils.class.getName() + ".map";

	private DoradoContextUtils() {
	}

	@SuppressWarnings("unchecked")
	private static Stack<Map<String, Object>> getViewContextStack(DoradoContext context) {
		Stack<Map<String, Object>> stack = (Stack<Map<String, Object>>) context.getAttribute(STACK_ATTRIBUTE);
		if (stack == null) {
			stack = new Stack<>();
	...
	@SuppressWarnings("unchecked")
	private static Map<Object, Map<String, Object>> getViewContextMap(DoradoContext context) {
		Map<Object, Map<String, Object>> map = (Map<Object, Map<String, Object>>) context.getAttribute(MAP_ATTRIBUTE);
		if (map == null) {
			map = new HashMap<>();
	...
	public static void pushNewViewContextIfNecessary(DoradoContext context) {
		...
		if (!stack.isEmpty()) {
			...
			if (viewContext != null) {
				for (Map<String, Object> bindedViewContext : getViewContextMap(context).values()) {
	...
	public static void pushNewViewContext(DoradoContext context, Map<String, Object> viewContext) {
	...
	public static Map<String, Object> getViewContextByBindingObject(DoradoContext context, Object object) {
