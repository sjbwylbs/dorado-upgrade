	...
	public SortableMethodInterceptorSet() {
		super(new Comparator<MethodInterceptor>() {
			...
			public int compare(MethodInterceptor o1, MethodInterceptor o2) {
				int order1 = (o1 instanceof PatternMethodInterceptor) ? ((PatternMethodInterceptor) o1).getOrder()
						: DEFAULT_ORDER;
				int order2 = (o2 instanceof PatternMethodInterceptor) ? ((PatternMethodInterceptor) o2).getOrder()
						: DEFAULT_ORDER;
