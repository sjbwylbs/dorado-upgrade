...
(function (window, $, undefined) {
    ...
    function paletteTemplate(p, color, className) {
        ...
        for (let i = 0; i < p.length; i++) {
            ...
            if (current) {
                ...
                html.push('<span title="No Color Selected" data-color="" style="background-color:transparent;" class="' +
                    cls +
                    '"></span>');
            }
        }
    ...
    function spectrum(element, o) {
        ...
        function updateUI() {
            ...
            let realColor = get({ format: format }), displayColor = "";
            ...
            if (!realColor && allowEmpty) {
                ...
                let realHex = realColor.toHexString(), realRgb = realColor.toRgbString();
        ...
        function updateOriginalInput(fireCallback) {
            let color = get(), displayColor = "", hasChanged = !tinycolor.equals(color, colorOnShow);
            if (color) {
    ...
    (function () {
        let trimLeft = /^[\s,#]+/, trimRight = /\s+$/, tinyCounter = 0, math = Math, mathRound = math.round, mathMin = math.min, mathMax = math.max, mathRandom = math.random;
        function tinycolor(color, opts) {
            ...
            let r = rgb.r, g = rgb.g, b = rgb.b, a = rgb.a, roundA = mathRound(100 * a) / 100, format = opts.format || rgb.format;
            if (r < 1) {
                r = mathRound(r);
            }
            if (g < 1) {
            ...
            return {
                ...
                toFilter: function (secondColor) {
                    ...
                    let gradientType = opts && opts.gradientType ? "GradientType = 1, " : "";
                    if (secondColor) {
                ...
                toString: function (format) {
                    ...
                    let formatWithAlpha = hasAlphaAndFormatNotSet &&
                        (format === "hex" ||
                            format === "hex6" ||
                            format === "hex3" ||
                            format === "name");
        ...
        tinycolor.readability = function (color1, color2) {
            ...
            let colorDiff = Math.max(a.r, b.r) -
                Math.min(a.r, b.r) +
                Math.max(a.g, b.g) -
                Math.min(a.g, b.g) +
                Math.max(a.b, b.b) -
...
(function () {
    ...
    dorado.widget.ColorPicker = $extend([dorado.widget.Control, dorado.widget.ColorPickerSupport], {
        ...
        createDom: function () {
            let colorPicker = this, inputDom = $DomUtils.xCreate({ tagName: "INPUT" });
            ...
            let $container = colorPicker._spectrum
                .spectrum(dorado.Object.apply(options, {
    ...
    dorado.widget.ColorEditor = $extend([dorado.widget.ColorPicker, dorado.widget.AbstractDataEditor], {
