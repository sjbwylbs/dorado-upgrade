...
(function ($, undefined) {
    ...
    $.position = {scrollbarWidth:function () {
        ...
        return {element:withinElement, isWindow:isWindow, isDocument:isDocument, offset:withinElement.offset() || {left:0, top:0}, scrollLeft:withinElement.scrollLeft(), scrollTop:withinElement.scrollTop(), width:isWindow ? withinElement.width() : withinElement.outerWidth(), height:isWindow ? withinElement.height() : withinElement.outerHeight()};
    }};
...
(function ($, undefined) {
    ...
    (function () {
        $.extend($.effects, {version:"1.10.4", save:function (element, set) {
