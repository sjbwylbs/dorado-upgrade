...
class UnexposeTest {
	...
	void should_have_runtime_retention_when_inspected() {
		Retention retention = Unexpose.class.getAnnotation(Retention.class);
	...
	void should_target_type_and_method_when_inspected() {
		Target target = Unexpose.class.getAnnotation(Target.class);
	...
	void should_be_inherited_when_inspected() {
		Inherited inherited = Unexpose.class.getAnnotation(Inherited.class);
