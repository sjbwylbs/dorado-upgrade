	...
	var plupload = {
		...
		ua: (function() {
			...
			return {
				...
				webkit: webkit,
				gecko: !webkit && (/Gecko/.test(userAgent) || /Trident/.test(userAgent)),
				safari: safari,
				opera: !!opera
			};
		}()),
			...
			init : function() {
				...
				function callNextInit() {
					...
					if (runtime) {
						...
						//set multi_selection
						if (self.settings.selectionMode=="singleFile"){
							features.multi_selection=false;
							self.settings.multi_selection=false;
						}
